...
def temperature(weather)
    puts weather.values[2]
end

puts "The weather in #{location(weather)} is #{description(weather)}. The temperature is #{temperature(weather)} degrees Farenheit."
